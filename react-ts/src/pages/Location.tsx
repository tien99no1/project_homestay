...
import { Container, Box, Button, FormControl, InputLabel, MenuItem, Select, SelectChangeEvent, Grid } from "@mui/material";
  ...
  return (
    ...
    <Grid container  rowSpacing={3} columnSpacing={{ xs: 1, sm: 1, md: 1.5 }}>
      ...
      <Grid item xl={3} sm={6} md={4} xs={12}>
          <Box className='Location'>
          <Box className="img-location">
              <img src="https://cdn.luxstay.com/users/407757/BXSWxc8JJfPItWkkKpNpwqMf.jpg" alt="" />
            </Box>
            <Box className="content-location">
                <span>Căn hộ dịch vụ - 1 phòng ngủ</span>
                <p>The Galaxy Home </p>
      ...
      <Grid item xl={3} sm={6} md={4} xs={12}>
          <Box className='Location'>
          <Box className="img-location">
              <img src="https://cdn.luxstay.com/users/354826/kV0JTJvfJaj8wTRMvSP9sIfD.jpg" alt="" />
            </Box>
            <Box className="content-location">
                <span>Căn hộ dịch vụ - 1 phòng ngủ</span>
                <p>The Galaxy Home </p>
      ...
      <Grid item xl={3} sm={6} md={4} xs={12}>
          <Box className='Location'>
          <Box className="img-location">
              <img src="https://cdn.luxstay.com/users/37752/AQ6iIGB9J_kOuNEpqQuGV6Uk.jpg" alt="" />
            </Box>
            <Box className="content-location">
                <span>Căn hộ dịch vụ - 1 phòng ngủ</span>
                <p>The Galaxy Home </p>
      ...
      <Grid item xl={3} sm={6} md={4} xs={12}>
          <Box className='Location'>
          <Box className="img-location">
              <img src="https://cdn.luxstay.com/users/351762/L571EGkJEWJBUqYaVNtZUTuF.JPG" alt="" />
            </Box>
            <Box className="content-location">
                <span>Căn hộ dịch vụ - 1 phòng ngủ</span>
                <p>The Galaxy Home </p>
      ...
      <Grid item xl={3} sm={6} md={4} xs={12}>
          <Box className='Location'>
          <Box className="img-location">
              <img src="https://cdn.luxstay.com/users/181012/cAR4-3BFtYrAMAyoiYz-fkeI.jpg" alt="" />
            </Box>
            <Box className="content-location">
                <span>Căn hộ dịch vụ - 1 phòng ngủ</span>
                <p>The Galaxy Home </p>
